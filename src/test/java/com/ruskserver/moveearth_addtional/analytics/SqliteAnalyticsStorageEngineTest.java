...
public class SqliteAnalyticsStorageEngineTest {
    ...
    private static final long JST_19_OPEN_DAY_OFFSET_SECONDS = 36_000L;
    ...
    public void testWritePlayerActivityAndDailyAggregation() throws Exception {
        ...
        long bucket1 = JST_19_OPEN_DAY_OFFSET_SECONDS + 86400L * 10 + 300L;
        long bucket2 = JST_19_OPEN_DAY_OFFSET_SECONDS + 86400L * 10 + 600L;
        ...
        engine.aggregateDaily(JST_19_OPEN_DAY_OFFSET_SECONDS + 86400L * 11);
    ...
    public void testAggregateDailyIdempotent() throws Exception {
        ...
        long t1 = JST_19_OPEN_DAY_OFFSET_SECONDS + 1000L; // 開放日 0 の 1000秒後
        long t2 = JST_19_OPEN_DAY_OFFSET_SECONDS + 2000L; // 開放日 0 の 2000秒後
        ...
        // 日次集約を 3 回連続実行
        for (int i = 0; i < 3; i++) {
            engine.aggregateDaily(JST_19_OPEN_DAY_OFFSET_SECONDS + 86400L);
        }
        ...
        var summary = engine.queryPlayerSummary(player, com.ruskserver.moveearth_addtional.analytics.query.dto.TimeWindow.ALL_TIME,
                JST_19_OPEN_DAY_OFFSET_SECONDS + 86400L + 100L);
    ...
    public void testJstOpenDay10MinCriteria() throws Exception {
        ...
        long baseJst19 = JST_19_OPEN_DAY_OFFSET_SECONDS;
    ...
    public void testFirstSeenAtAndOngoingSession() throws Exception {
        ...
        long now = JST_19_OPEN_DAY_OFFSET_SECONDS + 7200L;
        long firstSeen = JST_19_OPEN_DAY_OFFSET_SECONDS;

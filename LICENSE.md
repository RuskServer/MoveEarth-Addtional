# MoveEarth-Addtional licensing

This project contains components under multiple licenses.

## Original project code and assets

Unless a file or directory is identified below, the original Java source code
and original assets of MoveEarth-Addtional are licensed under the GNU Lesser
General Public License version 3 only (`LGPL-3.0-only`).

The applicable license texts are provided under `LICENSES/` in the source
repository and under `META-INF/licenses/moveearth_addtional/` in release JARs:
